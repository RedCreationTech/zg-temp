    ...
    reps: [
      {
        ...
        commitmentRate: 68,
        nbaCompletion: 82,
        next: "完成周敏高风险患者场景的 4 轮 AI 陪练",
        strength: "场景准备充分, 证据熟悉度高",
        risk: "容易过早进入证据呈现"
      },
      {
        id: "rep2",
        ...
        issue: "推进不够",
        repeated: 3,
        coachingStatus: "需立即辅导",
        practice: "待完成",
        practiceScore: 0,
        commitmentRate: 42,
        nbaCompletion: 63,
        next: "修复结束阶段, 把“下次再来”改成具体病例和时间",
        strength: "病例沟通清晰, 医生互动自然",
        risk: "连续三次重点拜访没有形成明确承诺"
      },
      {
        id: "rep3",
        name: "赵倩",
        ...
        issue: "可复制经验",
        repeated: 0,
        coachingStatus: "可沉淀经验",
        practice: "已通过",
        practiceScore: 92,
        commitmentRate: 88,
        nbaCompletion: 91,
        next: "把流程问题 → 病例共识会打法沉淀为团队 Rule",
        strength: "先探询流程问题, 再用同级案例推进",
        risk: "暂无高风险问题"
      },
      {
        id: "rep4",
        ...
        commitmentRate: 71,
        nbaCompletion: 79,
        next: "减少泛化产品表达, 把价值与患者选择标准绑定",
        strength: "探询稳定, 拜访节奏好",
        risk: "证据与医生当前决策标准匹配度不够"
      },
      {
        id: "rep5",
        name: "何伟",
        ...
        commitmentRate: 55,
        nbaCompletion: 67,
        next: "拜访前只保留一个目标行为, 不再同时推进多个议题",
        strength: "客户覆盖稳定",
        risk: "拜访目标较多, 经常导致结尾无法明确下一步"
      }
    ],
    patterns: [
      { id: "p1", name: "没有明确下一步承诺", count: 7, rate: 31, change: -4, dimension: "推进承诺", action: "本周经理辅导统一检查 Success Signal" },
      { id: "p2", name: "证据先于有效探询", count: 5, rate: 22, change: -2, dimension: "探询质量", action: "重点代表进入 AI 医生角色扮演" },
      { id: "p3", name: "呈现内容与当前 Context 不匹配", count: 4, rate: 18, change: 3, dimension: "证据匹配", action: "拜访前强制确认医生当前决策标准" },
      { id: "p4", name: "一次拜访同时推进多个目标", count: 3, rate: 13, change: 1, dimension: "目标清晰", action: "拜访前只保留一个目标行为" }
    ]
  },
